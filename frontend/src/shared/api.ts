...
export const api = {
  rooms: {
    ...
    students: {
      register_by_admin: (student: IStudent, roomId: string) =>
        axios.post<IRoom>(`/rooms/${roomId}/student`, student),
      update_by_admin: (student: IStudent, roomId: string, studentId: string) =>
        axios.put<IRoom>(`/rooms/${roomId}/student/${studentId}`, student),
      delete_by_admin: (roomId: string, studentId: string) =>
        axios.delete<IRoom>(`/rooms/${roomId}/student/${studentId}`)
    }
  },
  admins: {
